...
| Binary | Purpose |
|---|---|
| [`tavora`](./cmd/tavora) | The user CLI — manage workspaces, agents, skills, documents, MCP servers, evals, schedules, and more from your terminal |
...
go build ./...                          # build both
go test ./...                           # run tests
go run ./cmd/tavora workspace show      # CLI
