...
already exists in the workspace. Persona, tools, skills, and store
...
API keys are workspace-scoped by construction. After credentials, the
TUI picks an agent:

- If the workspace has exactly one agent → auto-select.
