...
func init() {
	...
	chatCompleteCmd.Flags().BoolVar(&chatUseRAG, "rag", false, "Enable RAG from product documents")
	...
	chatInteractiveCmd.Flags().BoolVar(&interactiveUseRAG, "rag", false, "Enable RAG from product documents")
